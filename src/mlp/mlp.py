...
import numpy as np
from .graph import ComputationalGraph, Node, Edge
...
class MLP:
    ...
    def __init__(self, layer_sizes: List[int], activations: List[str],
                 weight_init: str = "xavier", loss_fn: str = "mse",
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray,
            ...
            snapshot_interval: int = 10, callback: Optional[Callable] = None) -> Dict:
        """
        Train the MLP.
        ...
        for epoch in range(epochs):
            ...
            if verbose:
                ...
                print(f"Epoch {epoch+1}/{epochs} | Train Loss: {avg_train_loss:.4f} | Train Acc: {avg_train_acc:.4f}{val_str}")
