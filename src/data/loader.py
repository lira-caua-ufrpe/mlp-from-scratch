...
def load_heart_disease(data_dir: str = "data", download: bool = True) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def load_diabetes(data_dir: str = "data", download: bool = True) -> Tuple[np.ndarray, np.ndarray]:
    """
...
def preprocess_data(X: np.ndarray, y: np.ndarray,
                    test_size: float = 0.2,
                    random_state: int = 42,
                    scale: bool = True) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, Optional[StandardScaler]]:
    """
