...
class ExperimentHarness:
    ...
    def prepare_data(self) -> None:
        ...
        X_train_val, self.X_test, y_train_val, self.y_test = preprocess_data(
            ...
            random_state=self.config.seed, scale=False
        )
        ...
        self.X_train, self.X_val, self.y_train, self.y_val = preprocess_data(
            ...
            random_state=self.config.seed, scale=self.config.scale_data
        )
    ...
    def inference_demo(self, n_samples: int = 5) -> None:
        ...
        for idx in indices:
            ...
            print(f"  Predicted: {y_pred} (prob: {y_proba[0] if len(y_proba) == 1 else y_proba})")
